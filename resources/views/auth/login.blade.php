{{-- ================================================================
     ...
     ================================================================ --}}
@extends('layouts.app')
@section('title', 'Sign In — ThreatWatch Nigeria')
@section('content')
<div class="min-h-[calc(100vh-200px)] flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md">
                ...
                <div>
                    <label for="email" class="form-label">Email Address</label>
                        ...
                        <input id="email" type="email" name="email"
                            ...
                            class="form-input @error('email') border-red-400 focus:border-red-400 @enderror border-gray-800 border p-4 rounded-lg w-full">
                ...
                <div class="flex flex-col gap-x-2">
                    ...
                    <div class="relative" x-data="{ show: false }">
                        ...
                        <input id="password" :type="show ? 'text' : 'password'" name="password"
                               ...
                               placeholder="••••••••"
                               class="form-input pr-10 @error('password') border-red-400 @enderror p-4 border border-gray-800 rounded-lg w-full">
        ...
        <p class="text-center text-sm text-gray-500 mt-5">
            ...
            <a href="{{ route('register') }}" class="font-bold text-ng-green hover:text-ng-dark transition-colors">
                Create one →
            </a>
        </p>
    </div>
