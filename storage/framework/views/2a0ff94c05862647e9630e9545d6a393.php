...
<article class="bg-white rounded-2xl border border-gray-100 overflow-hidden
    ...
    <div class="h-1 w-full
        <?php echo e($incident->severity === 'critical' ? 'bg-red-500' :
    ...
    <div class="p-5 flex flex-col flex-1">
        ...
        <div class="flex items-center gap-2 flex-wrap mb-3">
            <span class="inline-flex text-[11px] font-bold px-2.5 py-1 rounded-lg severity-<?php echo e($incident->severity); ?>">
        ...
        <h3 class="font-display font-semibold text-gray-900 text-sm leading-snug mb-2 line-clamp-2 flex-1">
            <a href="<?php echo e(route('incidents.show', $incident->slug)); ?>"
        ...
        <p class="text-xs text-gray-500 line-clamp-2 leading-relaxed mb-4">
            <?php echo e($incident->short_description); ?>
        ...
        <div class="flex items-center justify-between gap-2 text-xs text-gray-400">
            <div class="flex items-center gap-1 min-w-0">
                ...
                <span class="truncate font-medium text-gray-600">
                    <?php echo e($incident->state->name); ?><?php echo e($incident->lga ? ' · ' . $incident->lga->name : ''); ?><?php echo e($incident->town ? ', ' . $incident->town : ''); ?>

                </span>
            </div>
            <span class="flex-shrink-0"><?php echo e($incident->incident_date?->format('d M Y')); ?></span>
        </div>
    </div>
    ...
    <div class="px-5 py-3 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
        <span class="text-xs text-gray-500">
            By <span class="font-medium"><?php echo e($incident->reporter_name); ?></span>
        </span>
        <div class="flex items-center gap-3">
            <span class="flex items-center gap-1 text-xs text-gray-400">
                <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                <?php echo e(number_format($incident->views)); ?>
...
<?php /**PATH C:\xampp\htdocs\threatwatch-nigeria\resources\views/partials/incident-card.blade.php ENDPATH**/ ?>