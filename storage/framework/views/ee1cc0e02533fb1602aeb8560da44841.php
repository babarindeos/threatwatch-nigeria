...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'ThreatWatch Nigeria — Real-time security incident tracking and reporting platform.'); ?>">
    <title><?php echo $__env->yieldContent('title', 'ThreatWatch Nigeria'); ?> — Securing the Nation</title>
...
<nav class="bg-white border-b border-gray-100 sticky top-0 z-50 shadow-sm" x-data="{ mobileOpen: false }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="hidden md:flex items-center gap-6">
                <a href="<?php echo e(route('incidents.index')); ?>"
                   class="nav-link text-sm font-medium text-gray-600 hover:text-ng-green transition-colors
                          <?php echo e(request()->routeIs('incidents.*') ? 'text-ng-green active' : ''); ?>">
                    Incidents
                </a>
                <a href="<?php echo e(route('heatmap')); ?>"
                   class="nav-link text-sm font-medium text-gray-600 hover:text-ng-green transition-colors
                          <?php echo e(request()->routeIs('heatmap') ? 'text-ng-green active' : ''); ?>">
                    Heatmap
                </a>
                <a href="<?php echo e(route('helplines')); ?>"
                   class="nav-link text-sm font-medium text-gray-600 hover:text-ng-green transition-colors
                          <?php echo e(request()->routeIs('helplines') ? 'text-ng-green active' : ''); ?>">
                    Emergency Lines
                </a>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open"
                            ...
                            <div class="px-4 py-3 border-b border-gray-50">
                                <p class="text-sm font-bold text-gray-900 truncate"><?php echo e(auth()->user()->full_name); ?></p>
                                <p class="text-xs text-gray-400 mt-0.5 capitalize"><?php echo e(auth()->user()->role_label); ?></p>
                            </div>
                            <div class="py-1">
                                <a href="<?php echo e(route('reports.my')); ?>"
        ...
        <div x-show="mobileOpen"
            ...
            <a href="<?php echo e(route('incidents.index')); ?>" class="block px-3 py-2.5 text-sm font-medium text-gray-700 hover:bg-ng-muted hover:text-ng-green rounded-xl transition-colors">Incidents</a>
            <a href="<?php echo e(route('heatmap')); ?>" class="block px-3 py-2.5 text-sm font-medium text-gray-700 hover:bg-ng-muted hover:text-ng-green rounded-xl transition-colors">Heatmap</a>
            <a href="<?php echo e(route('helplines')); ?>" class="block px-3 py-2.5 text-sm font-medium text-gray-700 hover:bg-ng-muted hover:text-ng-green rounded-xl transition-colors">Emergency Lines</a>
            <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('reports.create')); ?>" class="block px-3 py-2.5 text-sm font-bold text-ng-green hover:bg-ng-muted rounded-xl transition-colors">+ Report a Threat</a>
            <a href="<?php echo e(route('reports.my')); ?>" class="block px-3 py-2.5 text-sm font-medium text-gray-700 hover:bg-ng-muted rounded-xl transition-colors">My Reports</a>
            <?php endif; ?>
        </div>
    </div>
</nav>
...
<footer class="bg-gray-900 text-gray-400 mt-auto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm">
                    <li><a href="<?php echo e(route('incidents.index')); ?>" class="hover:text-ng-green transition-colors">Browse Incidents</a></li>
                    <li><a href="<?php echo e(route('heatmap')); ?>" class="hover:text-ng-green transition-colors">Attack Heatmap</a></li>
                    <li><a href="<?php echo e(route('helplines')); ?>" class="hover:text-ng-green transition-colors">Emergency Helplines</a></li>
                    <li><a href="<?php echo e(route('reports.create')); ?>" class="hover:text-ng-green transition-colors">Report a Threat</a></li>
                    <?php if(auth()->guard()->guest()): ?>
                    <li><a href="<?php echo e(route('register')); ?>" class="hover:text-ng-green transition-colors">Create Account</a></li>
                    <?php endif; ?>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <?php $__currentLoopData = ['🚔 Police' => '199 / 112', '🚑 Ambulance' => '0700-2625226', '🔥 Fire Service' => '01-272-0892', '🛡️ DSS Tip-off' => '08057000001', '🚗 FRSC' => '122']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $num): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="flex items-center justify-between gap-2">
                        <span><?php echo e($name); ?></span>
                        <strong class="text-white font-mono text-xs"><?php echo e($num); ?></strong>
                    </li>
        ...
        <div class="border-t border-gray-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
            <p>© <?php echo e(date('Y')); ?> ThreatWatch Nigeria. A civic-tech initiative 🇳🇬</p>
...
<?php /**PATH C:\xampp\htdocs\threatwatch-nigeria\resources\views/layouts/app.blade.php ENDPATH**/ ?>