<?php $__env->startSection('title', 'Nigeria Security Heatmap — ThreatWatch Nigeria'); ?>
<?php $__env->startSection('meta_description', 'Interactive security incident heatmap showing attack hotspots across all 36 states of Nigeria.'); ?>
...
<div class="flex flex-col lg:flex-row h-[calc(100vh-64px)]">
    ...
    <div class="w-full lg:w-72 xl:w-80 bg-white border-b lg:border-b-0 lg:border-r border-gray-100
        ...
        <div class="px-5 py-4 space-y-4 flex-1">
            ...
            <div>
                ...
                <select id="filter-type" class="form-input text-xs py-2">
                    ...
                    <?php $__currentLoopData = $attackTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="px-5 py-4 border-t border-gray-100">
            ...
            <div class="space-y-2">
                <?php $__currentLoopData = ['critical'=>['🔴','Critical','#ef4444'], 'high'=>['🟠','High','#f97316'], 'medium'=>['🟡','Medium','#f59e0b'], 'low'=>['🟢','Low','#22c55e']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center gap-2.5">
                    <div class="w-3 h-3 rounded-full flex-shrink-0" style="background:<?php echo e($info[2]); ?>"></div>
                    <span class="text-xs text-gray-600 font-medium"><?php echo e($info[1]); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
function applyFilters() {
    ...
    fetch(`<?php echo e(route('api.heatmap.data')); ?>?${params.toString()}`)
        .then(r => r.json())
        .then(data => {
            currentData = data;
            renderMap(data);
...
function showPopup(inc) {
    const typeLabels = <?php echo json_encode(\App\Models\Incident::ATTACK_TYPES, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\threatwatch-nigeria\resources\views/heatmap/index.blade.php ENDPATH**/ ?>